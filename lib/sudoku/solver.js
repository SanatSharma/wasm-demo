...
var marray = new Array(10);


function calcMandel(coorX, coorY) {
    var xmin = -500, ymin = -500, xmax = 500, ymax = 500;
    var width = xmax - xmin;
    var height = ymax - ymin;
    for (var h = 0; h < marray.length; h++) {
        marray[h] = new Array(marray.length);
    }
    for (var i = coorX; i < coorX + 10; i++) {
        for (var j = coorY; j < coorY + 10; j++) {
